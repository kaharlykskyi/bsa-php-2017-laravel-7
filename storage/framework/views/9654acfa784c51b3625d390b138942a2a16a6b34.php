<?php $__env->startSection('title', 'Create new car'); ?>
<?php $__env->startSection('create-active','active'); ?>

<?php $__env->startSection('content'); ?>
    <div class="panel panel-default">
        <div class="panel-heading">Add new car</div>
        <div class="panel-body">
            <form action="<?php echo e(URL::route('cars.store')); ?>" class="form-horizontal" role="form" method="POST">
                ...
                <div class="form-group <?php echo e($errors->has('model') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <input id="model" type="text" class="form-control" name="model" value="<?php echo e(old('model')); ?>" autofocus>
                ...
                <div class="form-group <?php echo e($errors->has('color') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <input id="color" type="text" class="form-control" name="color" value="<?php echo e(old('color')); ?>">
                ...
                <div class="form-group <?php echo e($errors->has('registration_number') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <input id="registration_number" type="text" class="form-control" name="registration_number" value="<?php echo e(old('registration_number')); ?>">
                ...
                <div class="form-group <?php echo e($errors->has('year') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <input id="year" type="text" class="form-control" name="year" value="<?php echo e(old('year')); ?>">
                ...
                <div class="form-group <?php echo e($errors->has('mileage') ? 'has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <input id="mileage" type="text" class="form-control" name="mileage" value="<?php echo e(old('mileage')); ?>">
